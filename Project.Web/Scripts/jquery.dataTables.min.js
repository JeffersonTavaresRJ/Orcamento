...
!a.sEmptyTable&&(c&&"Dados não encontrados"===b.sEmptyTable)&&E(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&(c&&"Carregando..."===b.sLoadingRecords)&&E(a,a,"sZeroRecords","sLoadingRecords");a.sInfoThousands&&(a.sThousands=a.sInfoThousands);(a=a.sDecimal)&&db(a)}function eb(a){A(a,"ordering","bSort");A(a,"orderMulti","bSortMulti");A(a,"orderClasses","bSortClasses");A(a,"orderCellsTop","bSortCellsTop");A(a,"order","aaSorting");A(a,"orderFixed","aaSortingFixed");A(a,"paging","bPaginate");
...
oPaginate:{sFirst:"<<",sLast:">>",sNext:">",sPrevious:"<"},sEmptyTable:"Dados não encontrados",sInfo:"Exibindo _START_ de _END_ do total de _TOTAL_ registros",sInfoEmpty:"Exibindo 0 de 0 do total de 0 registros",sInfoFiltered:"(filtrados: _MAX_ registro(s))",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Exibindo _MENU_ registros",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Busca no resultado da pesquisa:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},
